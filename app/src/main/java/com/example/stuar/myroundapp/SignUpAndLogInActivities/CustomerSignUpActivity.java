...
public class CustomerSignUpActivity extends AppCompatActivity {
                    ...
                    .addOnCompleteListener(this, new OnCompleteListener<AuthResult>() {
                        ...
                        public void onComplete(@NonNull Task<AuthResult> task){
                            if(task.isSuccessful()){
                                ...
                                Toast.makeText(CustomerSignUpActivity.this, "Account created", Toast.LENGTH_SHORT).show();

                            }
                            else{
                                if(task.getException() instanceof FirebaseAuthUserCollisionException){
                                    Toast.makeText(CustomerSignUpActivity.this, "Already Registered", Toast.LENGTH_SHORT).show();
                                }
                                else{
                                    Toast.makeText(CustomerSignUpActivity.this, task.getException().getMessage(), Toast.LENGTH_SHORT).show();
                                }
    ...
    private void CreateAccount() {
        ...
        if (TextUtils.isEmpty(email)) {
            ...
            createNewUser(email, phone, password);
        }
    }


    private void createNewUser(final String name, final String phone, final String password) {
...
/*
    ...
    private void addUser(){
        ...
        //if password does not contain a number
        if(!password.matches(".*\\d+.*")){
            Toast toast = Toast.makeText(CustomerSignUpActivity.this, "Password must contain a number", Toast.LENGTH_SHORT);
            toast.show();
        }
        ...
        //password and password confirmation must be identical
        if(!password.equals(confirmPassword)){
                Toast passwordMsg = Toast.makeText(CustomerSignUpActivity.this, "Passwords don't match", Toast.LENGTH_SHORT);
                passwordMsg.show();
        }
    ...
    public void onLogInLinkBtnClick(View view) {
        if(view.getId() == R.id.logInLinkBtn){
            startActivity(new Intent(CustomerSignUpActivity.this, LogIn.class));
        }
    }*/
}
