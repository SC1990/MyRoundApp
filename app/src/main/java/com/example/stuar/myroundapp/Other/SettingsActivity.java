...
import com.example.stuar.myroundapp.SignUpAndLogInActivities.ForgotPasswordActivity;
...
public class SettingsActivity extends AppCompatActivity{
    ...
    private void userInfoDisplay(final CircleImageView imageView, final EditText fullNameET, final EditText userPhoneET, final EditText addressET) {
                ...
                if (dataSnapshot.exists()) {
                    if (dataSnapshot.child("image").exists()) {
                        ...
                        if(image.equals("empty")){
                            Picasso.get().load(R.drawable.av).into(imageView);

                        }else{
                            Picasso.get().load(RememberMe.currentOnlineUser.getImage()).into(imageView);
                        }
